...
import useAddBeneficiary from "@/pages/private/beneficiaries/hooks/use-add-beneficiary";
...
const AddBeneficiaryModal = ({
  ...
  setOpenAddBeneficiaryModal,
  onSuccess,
}: {
  openAddBeneficiaryModal: boolean;
  setOpenAddBeneficiaryModal: (val: boolean) => void;
  onSuccess: () => void;
}) => {
  ...
  const schema = yup.object({
    ...
    date_of_birth: validateAgeRangeWithYup({
      minAge,
      maxAge,
  ...
  return (
    <CustomDialog
      ...
      description="Fill in the details below to add a new beneficiary."
      openModal={openAddBeneficiaryModal}
      onClose={() => setOpenAddBeneficiaryModal(false)}
