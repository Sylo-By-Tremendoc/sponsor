...
const WhyThisMatters = ({ setShowGetStartedModal }: SectionParam) => {
  ...
  return (
    <div>
      {/* WHY THIS MATTERS */}
      <Section className="flex flex-col gap-8 bg-[#F9F9FB]">
        <div className="grid md:grid-cols-2 gap-10 i">
          <motion.div
          ...
          >
            ...
            <TitleText className="mx-0 md:max-w-88">
              When life takes you abroad, their health back home shouldn’t be a
              gamble.
            </TitleText>

            <img src={whyThisMattersImg} alt="Why this matters" />
          </motion.div>
