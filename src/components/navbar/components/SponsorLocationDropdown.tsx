...
export type SponsorLocationDropdownParams = {
  id: string;
  label: string;
  symbol: string;
  flag: string;
...
export const SponsorLocationDropdown = ({
  children,
  sameWidthAsTrigger,
  selectedSponsor,
  changeSponsor,
  ...
  selectedSponsor?: SponsorLocationDropdownParams;
...
export default SponsorLocationDropdown;
