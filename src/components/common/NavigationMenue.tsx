...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-[30px] items-center justify-center rounded-full bg-background px-4 py-2 text-body-xs bg-transparent text-charcoal-grey/90 font-bold transition-colors bg-transparent hover:text-black hover:bg-light-grey focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-light-grey"
);
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-3xl bg-background text-popover-black shadow-[3px_4px_4px_1px_#0000001A] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:w-(--radix-navigation-menu-viewport-width)",
        className
      )}
      ref={ref}
      {...props}
